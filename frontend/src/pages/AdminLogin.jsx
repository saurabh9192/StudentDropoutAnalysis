  ...
  const submitLogin = async (e) => {
    ...
    try {
      ...
      if (res.status === 422 || !data) {
        ...
        window.alert("NO ADMIN WITH THESE CREDENTIALS");
      } else if (res.status === 401) {
        window.alert("INVALID CREDENTIALS");
      } 
      else {
        window.alert("Success");
        navigate('/welcomeafteradminlogin');
      }
    ...
    <section id="about">
      <div className="container-fluid px-0">
        <div className="container mb-md-0 mt-5">
          <h1 className="au-text">Admin Login to <img src={KoshishLogo} alt="" width="180" className="logo" style={{width: "13rem", marginTop: '-0.5rem', marginLeft: '0rem'}} /></h1>
